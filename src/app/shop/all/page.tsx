...
function AllProductsContent() {
  ...
  const filteredProducts = React.useMemo(() => {
    ...
    // 3. Theme, Color & Size mock filters (match search phrases in name or category)
    ...
    <div className="bg-white min-h-screen pb-24 flex flex-col items-center">
      ...
      <header className="max-w-[1440px] w-full mx-auto text-left space-y-6 px-6 md:px-[80px] pt-[62px] pb-[24px]">
        ...
        <div className="flex items-center gap-2 text-xs font-sans text-slate-400 font-medium pt-2">
          ...
          <span className="text-slate-300">&gt;</span>
          <span className="text-[#2B2B2B] font-bold">Product Categories</span>
        </div>
      </header>
