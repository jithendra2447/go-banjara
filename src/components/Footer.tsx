...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-[#1D493E] text-slate-200 border-t border-white/5 pt-16 pb-8 px-6 font-sans">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 px-2 md:px-12">
      ...
      {/* Divider */}
      <div className="max-w-[1440px] mx-auto border-t border-white/10 my-6 px-2 md:px-12"></div>

      {/* Copyrights Bar */}
      <div className="max-w-[1440px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-300/70 px-2 md:px-12">
