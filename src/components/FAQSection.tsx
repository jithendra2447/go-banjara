  ...
  const renderTwoColorTitle = (rawTitle: string) => {
    ...
    return (
      <span className="inline">
        {mainPart}&nbsp;<span className="text-[#FF5B37]">{highlightPart}</span>
      </span>
    );
  };

  return (
    <section className={`w-full max-w-[1440px] mx-auto py-8 md:py-16 ${noPadding ? '' : 'px-6 md:px-[80px]'} text-left ${className}`}>
