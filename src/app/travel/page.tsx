      ...
      <section id="available-packages" className="max-w-[1440px] mx-auto px-3 sm:px-6 md:px-[80px] pt-1 sm:pt-10 pb-6 sm:pb-12 space-y-3 sm:space-y-10">
        ...
        <div 
          style={{
            ...
            maxWidth: "1280px",
            borderRadius: "16px",
            border: "1px solid rgba(255, 91, 55, 1)",
            boxShadow: "0px 4px 12px 0px rgba(255, 91, 55, 0.24)",
            background: "rgba(255, 255, 255, 1)",
            boxSizing: "border-box",
            marginLeft: "auto",
            marginRight: "auto",
          }}
          className="hidden md:block text-left relative z-30 h-auto p-4 sm:p-6"
        >
          <div className="w-full flex flex-col md:flex-row gap-6 items-stretch md:items-center">
            
            {/* Field 1: Destination */}
            <div className="flex-1 md:flex-[1.2] flex flex-col gap-2">
              <label style={{ 
                fontFamily: "'Faktum', 'Outfit', sans-serif", 
                fontWeight: 500, 
                lineHeight: "100%", 
              ...
              >
                ...
                <input
                  ...
                  className="placeholder-[rgba(141,141,141,1)] text-sm sm:text-base md:text-[18px]"
                />
              </div>
            </div>

            {/* Field 2: Date (Two Side-by-Side Date Inputs) */}
            <div className="flex-1 md:flex-[1.6] flex flex-col gap-2">
              <label style={{ 
                fontFamily: "'Faktum', 'Outfit', sans-serif", 
                fontWeight: 500, 
                lineHeight: "100%", 
              ...
              <div className="flex items-center gap-3 w-full">
                {/* Start Date Input */}
                <div 
                  className="flex-1 h-[56px] border border-[rgba(141,141,141,0.5)] rounded-[8px] px-3 sm:px-4 flex items-center gap-2 bg-white relative"
                >
                  <Calendar 
                    className="w-5 h-5 text-[rgba(141,141,141,1)] shrink-0 cursor-pointer hover:text-[#1D493E] transition-colors" 
                    onClick={() => {
                      try {
                  ...
                  <input
                    ...
                    className="placeholder-[rgba(141,141,141,1)] text-sm md:text-[18px] w-full"
                  />
                  <input 
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-baseline justify-between w-full gap-2">
                        ...
                        >
                          <h3 
                            ...
                            className="text-[14px] sm:text-xl md:text-[22px] truncate block leading-snug"
                            title={pkg.name}
                          >
                            {pkg.name}
                          </h3>
                        ...
                        <span 
                          style={{ fontFamily: "'Faktum', 'Outfit', sans-serif", color: "#1D493E" }}
                          className="font-bold text-[14px] sm:text-lg md:text-[22px] shrink-0 whitespace-nowrap"
                        >
                      ...
                      <p 
                        ...
                        className="text-[10px] sm:text-xs md:text-[15px] leading-relaxed"
                    ...
                    >
                      ...
                      <Link 
                        ...
                        className="h-full text-[16px] bg-[#FFFFFF] text-[#1D493E] hover:bg-[#EEF2F1] transition-colors duration-300"
                      >
                        Get details
                      </Link>
                    </div>
        ...
        {filteredAndSortedPackages.length > visiblePackagesCount && (
          <div className="pt-3 sm:pt-8 text-center">
            <button
              ...
              className="hidden md:inline-flex items-center justify-center h-[68px] px-[36px] rounded-[8px] bg-transparent hover:bg-gray-200/80 text-[#1D493E] transition-all duration-300 cursor-pointer border-none"
            ...
            <button
              type="button"
              onClick={() => setVisiblePackagesCount(prev => prev + 6)}
              className="md:hidden inline-flex items-center justify-center bg-transparent text-[#1D493E] px-5 py-2 text-sm font-semibold border-none cursor-pointer"
