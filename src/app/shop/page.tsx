  ...
  return (
    <div className="bg-white min-h-screen pb-24 flex flex-col items-center">
      ...
      <main className="w-full max-w-[1440px] mx-auto mt-0 px-6 md:px-[80px]">
        ...
        <section className="bg-white py-16 text-center w-full border-t border-slate-100 mt-8 animate-in fade-in duration-300">
          <div className="max-w-4xl mx-auto px-6 space-y-6">
            <h2 className="text-2xl md:text-[34px] font-serif text-[#1A1A1A] leading-tight font-medium">
              The <span className="text-[#FF5B37] font-serif">best adventures</span> find their way to your inbox.
            </h2>
            <p className="text-xs md:text-sm text-slate-555 max-w-2xl mx-auto leading-relaxed">
              Hidden places, exclusive trip drops, curated gear, and stories from the road delivered before anyone else hears about them.
            </p>
            <div className="pt-2">
              <Link
                href="/travel"
                className="inline-flex items-center gap-2 bg-[#1D493E] hover:bg-[#16372f] text-white px-8 py-3.5 rounded-lg font-bold text-xs uppercase tracking-widest transition duration-300 shadow-sm cursor-pointer"
              >
